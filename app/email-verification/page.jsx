...
import { resendVerificationEmail } from '../(auth)/resend/resendVerificationEmail';
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-purple-200 p-4">
      ...
      <div className="w-full max-w-md mb-4">
        <div className="flex justify-between text-sm text-gray-600">
          <div className="text-violet-500 font-semibold">Sign Up</div>
          <div className="text-violet-500 font-semibold">Email Verification</div>
      ...
      <div className="bg-white shadow-lg rounded-lg overflow-hidden transform hover:scale-105 transition-transform duration-200 max-w-md mb-8">
        <Image
          src={EmailImage}
      ...
      <div className="bg-orange-400 p-4 rounded-lg text-left text-white mb-4 w-full max-w-lg lg:max-w-md mx-auto">
